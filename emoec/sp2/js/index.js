...
var pop_up_note_mode = true;
        ...
        function popup_note() {
            ...
            note.style.cssText = "visibility:visible;position:absolute;background-image:url('images/music-span.png');width:15px;height:25px";
        ...
        function playbksound() {
            ...
            if (audiocontainer != undefined) {
                audiocontainer.innerHTML = '<audio id="bgsound" loop="loop" autoplay="autoplay"> <source src="images/music.mp3" /> </audio>';
            }
            ...
            if (document.body.offsetWidth > 400) {
                bg_htm = "<img id='sound_image' src='images/musicon.png'>";
                box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:-20px;top:-80px'></div>";
            }
            else {
                bg_htm = "<img id='sound_image' width='30px' src='images/musicon.png'>";
